...
class User(AbstractUser, BaseModel):
    ...
    def check_email(self):
        if self.email:
            normalize_email = self.email.lover()
...
class UserConfirmation(BaseModel):
    ...
    verify_type = models.CharField(max_length=13, choices=TYPE_CHOICES)
    user = models.ForeignKey('apps.users.User', on_delete=models.CASCADE, related_name='verify_codes')
